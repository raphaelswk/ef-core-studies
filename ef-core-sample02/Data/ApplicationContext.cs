...
namespace MasteringEFCore.Data
{
    public class ApplicationContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            const string strConnection = "Server=localhost,1433;Database=MasteringEFCoreDB;User Id=sa;Password=#MyPass123;Trusted_Connection=false;MultipleActiveResultSets=true";
            optionsBuilder
